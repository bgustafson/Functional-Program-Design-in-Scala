  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) < 0)) {
        ...
        var n = (((-jsx$1) + $uD($g.Math.sqrt(x))) / (2 * $uD(a$2.apply__O())));
        var jsx$2 = $uD(b$2.apply__O());
        var x$1 = $uD(delta$1.apply__O());
        var p = (((-jsx$2) - $uD($g.Math.sqrt(x$1))) / (2 * $uD(a$2.apply__O())));
        var array = [n, p];
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, b$1, c$1) {
    return (function() {
      var x = $uD(b$1.apply__O());
      return ($uD($g.Math.pow(x, 2.0)) - ((4 * $uD(a$1.apply__O())) * $uD(c$1.apply__O())))
    })
  })(a, b, c));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      ...
      return ((count >= 15) ? "green" : ((count < 0) ? "red" : "orange"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(tuple) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, tuple$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr($as_Lcalculator_Signal(tuple$1.$$und2$f).apply__O()), arg$outer.namedExpressions$1$f)
    })
  })(this, tuple));
  var signal = new $c_Lcalculator_Signal().init___F0(expr);
  var self = tuple.$$und1$f;
  return new $c_T2().init___O__O(self, signal)
});
